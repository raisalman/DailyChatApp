...
import com.example.dailychatapp.databinding.ActivitySignUpBinding;
        ...
        binding.btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(SignUpActivity.this, "Plz Enter all input fields", Toast.LENGTH_SHORT).show();
                }
            }
        });
